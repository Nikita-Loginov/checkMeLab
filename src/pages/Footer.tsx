...
const Footer: React.FC = () => {
  ...
  const serviceLinks = [
    { name: 'Самопознание', href: '#personal-plans' },
    { name: 'Обалдеть', href: '#amazing' },
    { name: 'Как начать', href: '#getting-started' },
    { name: 'VIP продукты', href: '#vip' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-xl font-bold">check.me-lab</div>
                <div className="text-sm text-gray-400">Тестирование навыков</div>
              </div>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Инновационная платформа для комплексной оценки Hard, Soft и Psy навыков. 
              Помогаем компаниям находить идеальных сотрудников с 95% точностью.
            </p>
          ...
          >
            ...
            <div className="mb-6">
              <p className="text-xs text-gray-400 leading-relaxed">
                Вся информация, размещенная на сайте, не является публичной офертой, определяемой положениями Статьи 437 Гражданского кодекса РФ.
              </p>
            </div>
