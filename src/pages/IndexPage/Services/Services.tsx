  ...
  const skillsData = {
    ...
    soft: [
      {
        ...
        now: 50,
        finish: 85,
        speedometerFirstColor: "green" as CvetType,
        speedometerSecondColor: "yellow" as CvetType,
      },
      {
        name: "Коммуникация",
        ...
        now: 75,
        finish: 96,
        speedometerFirstColor: "yellow" as CvetType,
        speedometerSecondColor: "red" as CvetType,
      },
      {
        name: "Эмпатия",
        ...
        now: 87,
        finish: 49,
        speedometerFirstColor: "orange" as CvetType,
        speedometerSecondColor: "green" as CvetType,
      },
      {
        name: "Креативность",
        ...
        now: 99,
        finish: 80,
        speedometerFirstColor: "blueviolet" as CvetType,
        speedometerSecondColor: "orange" as CvetType,
      },
      {
        name: "Адаптивность",
    ...
    psy: [
      ...
      },
      {
        ...
        now: 97,
        finish: 99,
        speedometerFirstColor: "red" as CvetType,
        speedometerSecondColor: "blueviolet" as CvetType,
      },
      {
        name: "Внимательность",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary-500 mb-6">
            <span className="text-gradient">Обалдеть!</span>
          </h2>
          <p className="text-xl text-gray-500 max-w-3xl mx-auto">
            Настолько точно, что вы удивитесь результатам.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col gap-8">
            ...
            {/* <div className={css.decor}>
              <div className={css["line-decor-box"]} style={{ width: "70%" }}>
                <p className="">0%</p>
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["green"],
                  }}
                ></div>
              </div>

              <div className={css["line-decor-box"]} style={{ width: "15%" }}>
                <p className="">71%</p>
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["yellow"],
                  }}
                ></div>
              </div>

              <div className={css["line-decor-box"]} style={{ width: "5%" }}>
                <p className="">86%</p>
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["orange"],
                  }}
                ></div>
              </div>
              ...
              <div className={css["line-decor-box"]} style={{ width: "5%" }}>
                ...
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["orangeDark"],
                  }}
                ></div>
              </div>

              <div className={css["line-decor-box"]} style={{ width: "3%" }}>
                <p className="">96%</p>
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["red"],
                  }}
                ></div>
              </div>

              <div className={css["line-decor-box"]} style={{ width: "2%" }}>
                <p className="">99%</p>
                <div
                  className={css["line-decor"]}
                  style={{
                    backgroundColor: CVETS["blueviolet"],
                  }}
                ></div>
              </div>
            </div>

            <ul className="font-semibold grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <li className={css.item}>
                <p>Зеленый – Базовый уровень (0 - 70%)</p>
              ...
              <li className={css.item}>
                <p>Желтый – Умеренный уровень (71 - 85%)</p>
              ...
              <li className={css.item}>
                <p>Оранжевый – Оптимальный уровень (86 - 90%)</p>
              ...
              <li className={css.item}>
                <p>Темно-оранжевый – Высокий уровень (91 - 95%)</p>
              ...
              <li className={css.item}>
                <p>Красный – Критический уровень (96 - 98%)</p>
              ...
              <li className={css.item}>
                <p>Фиолетовый – Экстремальный уровень (99 - 100%)</p>
