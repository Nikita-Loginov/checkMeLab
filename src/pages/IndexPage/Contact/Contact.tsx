...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Телефон",
      content: "+7 (984) 333-34-35",
      link: "tel:+79843333435",
    },
    {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.src =
      "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A3a9ec077286d7e9866c3c5c49a94cfc2715a97af78815b62472b46dc42eb83c6&amp;width=983&amp;height=493&amp;lang=ru_RU&amp;scroll=true";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              ...
              <p className="text-gray-500 mb-8">
                Готовы ответить на ваши вопросы и помочь выбрать подходящее
          ...
          >
            ...
            <div className={css.map} ref={mapRef}></div>
          </motion.div>
