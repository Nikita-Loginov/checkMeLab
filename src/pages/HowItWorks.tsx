  ...
  const steps = [
    {
      ...
      title: 'Заявка',
      description: 'Оставьте нам заявку, укажите в ней основную информацию о компании и вашу «боль»',
      features: ['Быстрое оформление', 'Описание потребностей', 'Выбор решения']
    },
    {
      number: '02',
      icon: <ClipboardDocumentListIcon className="w-8 h-8" />,
      title: 'Тестирование',
      description: 'Сотрудник или кандидат проходит комплексное исследование SOFT и PSY навыков в удобное для них время',
    ...
    },
    {
      ...
      description: 'Подробный отчет с анализом способностей сотрудника или кандидата и рекомендации',
      features: ['Детальная аналитика', 'Сравнение с эталоном', 'прогноз успешности']
    },
    {
      number: '04',
      icon: <CheckBadgeIcon className="w-8 h-8" />,
      title: 'Принятие решения',
      description: 'Принимайте кадровые решения на основе объективных данных и потенциала сотрудников',
      features: ['Объективная оценка', 'Снижение рисков', 'Повышение эффективности']
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto">
            От идеи до результата за 4 простых шага. 
            Начните сегодня и уже через неделю увидьте первые результаты
          </p>
        </motion.div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <span className={`text-sm ${
                  feature.highlight ? 'font-semibold text-primary-500' : 'text-gray-500'
                }`}>
                  {feature.text}
                </span>
              </motion.div>
